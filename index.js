...
async function sendNotification() {
  let notificationText = `𝐑𝐞𝐩𝐨𝐫𝐭:𝐇𝐞𝐥𝐥𝐨 *𝐑𝐀𝐕𝐈𝐍𝐃𝐔 𝐌𝐃 𝐕1* 𝐎𝐖𝐍𝐄𝐑 𝐀𝐌 𝐔𝐒𝐈𝐍𝐆 𝐑𝐀𝐕𝐈𝐍𝐃𝐔 𝐌𝐃 𝐕1 𝐁𝐎𝐓.𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𝐁𝐎𝐓.
...
sendNotification(); //  මට මැසේජ් එක එවන්න
...
*ᴛʜᴀɴᴋꜱ ꜰᴏʀ ᴜꜱɪɴɢ ʀᴀᴠɪɴᴅᴜ-ᴍᴅ Wʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ* ❤`;
  ...
  //ඩීලිට් සේව් කරන්න අයේ සෙන්ඩ් Anti delete on
  ...
  //වෙල්කම් ගුඩ්බායි අප්ඩේට්

  conn.ev.on("group-participants.update", (update) => GroupEvents(conn, update));	  
	  
  // ස්ටේටස් සීන් කරන තැන
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('94763079634', '94763079634', '94763079634');
